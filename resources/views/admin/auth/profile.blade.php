        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="{{ $errors->has('change_password') || $errors->has('current_password') || $errors->has('new_password') ? '' : 'active' }}"><a href="#activity" data-toggle="tab">Bio</a></li>
              <li class="{{ $errors->has('change_password') || $errors->has('current_password') || $errors->has('new_password') ? 'active' : '' }}"><a href="#settings" data-toggle="tab">Change Password</a></li>
            </ul>
            <div class="tab-content">
              <div class="{{ $errors->has('change_password') || $errors->has('current_password') || $errors->has('new_password') ? '' : 'active' }} tab-pane" id="activity">
                <!-- Post -->
                <div class="post">
                  <p>{{ Auth::user()->bio }}</p>
                </div>
              ...
              <div class="{{ $errors->has('change_password') || $errors->has('current_password') || $errors->has('new_password') ? 'active' : '' }} tab-pane" id="settings">
