              ...
              @foreach($teams as $team)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ Route('team.destroy', $team->id) }}" onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-danger btn-flat btn-sm"> <i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
              @endforeach
            </table>
